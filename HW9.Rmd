...
kable(final, row.names = FALSE, col.names = c("Term", "Estimate", "Lower Bound 95% CI", "Upper Bound 95% CI"), digits = 2, caption = "Interaction Regression Estimates and 95% Confidence Intervals") %>% 
